...
public class PromjenaDir implements ChainPromjenaI {
    ...
    public void process(ModelPromjena model, PrintWriter write, int i, String dat) {
        if (model.getTipPromjene() == 4) {

            //dodaj u listu
            if (dat == null && i == 1) {
                System.out.println("PROMJENA : Razlika je " + model.getRazlika() + " direktorija ");
    ...
    public void write(ModelPromjena model, PrintWriter out, String dat) {
        ...
        try {
            ...
            String zapis = "CIKLUS ->" + model.getBrojCiklusaPromjene() + " PROMJENA -> Razlika je " + model.getRazlika() + " direktorija";
