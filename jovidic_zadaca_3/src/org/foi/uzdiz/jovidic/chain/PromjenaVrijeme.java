 ...
 * datoteku
 */
public class PromjenaVrijeme implements ChainPromjenaI {
    ...
    public void process(ModelPromjena model, PrintWriter write, int i, String dat) {
        if (model.getTipPromjene() == 1) {

            //dodaj u listu
            if (dat == null && i == 1) {
                System.out.println("PROMJENA VREMENA IZMJENE: Za " + model.getNaziv() + " se promijenilo vrijeme izmjene, vrijeme citanja promjene " + model.getVrijemeCitanja() + " vrijeme promjene 1 je : " + model.getStaraVrijednost() + " a vrijeme promjene 2 je : " + model.getNovaVrijednost());
//ako datoteka null samo spremaj u listu
    ...
    public void write(ModelPromjena model, PrintWriter out, String dat) {
        ...
        try {
            ...
            String zapis = "CIKLUS ->" + model.getBrojCiklusaPromjene() + " PROMJENA -> PROMJENA VREMENA IZMJENE : Za " + model.getNaziv() + " se promijenila veličina, vrijeme citanja promjene je " + model.getVrijemeCitanja() + " velicina 1 je : " + model.getStaraVrijednost() + " a velicina 2 je : " + model.getNovaVrijednost();
