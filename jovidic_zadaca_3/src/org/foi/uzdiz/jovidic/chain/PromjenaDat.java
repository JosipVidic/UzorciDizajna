 ...
 *
 * @author jovidic 
 * Klasa koja implementira sučelje ChainPromjena te obzirom na
 * parametre ispisuje promjene na ekran, upisuje ih u unešenu datoteku, ili
 * unosi u doatnu datoteku
 */
public class PromjenaDat implements ChainPromjenaI {
    ...
    public void process(ModelPromjena model, PrintWriter write, int i, String dat) {
        if (model.getTipPromjene() == 3) {

            //dodaj u listu
            if (dat == null && i == 1) {
                System.out.println("PROMJENA : Razlika je " + model.getRazlika() + " datoteka");
    ...
    public void write(ModelPromjena model, PrintWriter out, String dat) {
        ...
        try {
            ...
            String zapis = "CIKLUS ->" + model.getBrojCiklusaPromjene() + " PROMJENA -> Razlika je " + model.getRazlika() + " datoteka";
